...
module.exports = (prDir, action) => {
    ...
    co(function *() {
        ...
        var sassCompile = function (output) {
        ...
        var tplCompile = function (output) {
        ...
        gulp.task('sass', function () {
            return sassCompile(projectDir + 'src/css');
        });

        //compile tpl to html
        gulp.task('tpl', function () {
            return tplCompile(projectDir + 'src/view');
        });

        gulp.task('css', ['clean'], function () {
            return sassCompile(buildDir + 'css'); 
        });
        ...
        gulp.task('build', ['css', 'fonts', 'js', 'images'], function () {
            return tplCompile(buildDir + 'pages');
        });
