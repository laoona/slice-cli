...
module.exports = (prDir, action, callback, opts) => {
    ...
    co(function *() {
        ...
        let smarty4jsConf = {
            baseDir: smartyConf.baseDir || projectDir + '/templates',
            templateDataDir: smartyConf.templateDataDir || projectDir + '/data',
            dataManifest: smartyConf.dataManifest || {},
            constPath: smartyConf.constPath,
            rootDir: smartyConf.rootDir || projectDir
        };
        ...
        gulp.task('tpl-smarty', function () {
            console.log(base64Cfg.extensions[0]);
            return gulp.src(tplDir)
